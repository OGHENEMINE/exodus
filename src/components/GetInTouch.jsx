  ...
  return (
    <section className="bg-black py-16 px-6 text-center text-white">
      <div className="space-y-6 max-w-2xl mx-auto">
        <h2 className="text-4xl font-bold font-primary">Get in Touch</h2>
        <p className="text-lg leading-relaxed">
          Whether you're a model, brand, scout, or bold visionary — we're always
          open to conversations and collaborations.
        </p>

        <div className="flex max-sm:flex-col items-center gap-5 justify-center">
          {/* Email */}
          {/* <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="transition-all duration-300 ease-in-out hover:underline hover:text-gray-300"
